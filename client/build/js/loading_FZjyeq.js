(function()
{
    ...
    (function(){
            ...
            startAnimation(list,function(){
                var div=document.getElementById("easyLoading");
                if(!div){
